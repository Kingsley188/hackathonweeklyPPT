...
export default function Milestones() {
  const milestones = [
    ...
    },
    {
      date: "2025.07",
      title: "主题形式多元化",
      description: "新增健康、机器人、出海SEO等主题探索AI落地，并与律所等共创活动",
    },
    {
      date: "2025.11",
      title: "生态共建",
      description: "与斯坦福大学AI社区、腾讯智能云、字节跳动等社区和企业已联办多场AI活动",
    },
    {
      date: "2025.12",
      title: "开发者先锋大会",
      description: "共举办近200场AI活动，培养了一大批AI开发者、设计师、AI产品经理",
    },
  ];

  const stats = [
    { label: "社区人数", value: "1W+" },
    { label: "活动场次", value: "200+场" },
    { label: "城市分布", value: "6个" },
    { label: "创业项目", value: "50+" },
    { label: "主理人", value: "50+" },
